...
class UsersTests(APITestCase):
    ...
    def test_update_user_info(self):
        ...
        response = self.client.patch(
            f"/api/v1/users/area/{self.user_1.id}/", updated_data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
